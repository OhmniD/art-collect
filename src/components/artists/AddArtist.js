...
const AddArtist = ({ artists, setArtists }) => {
	...
	const handleSubmit = async () => {
		...
		setArtists([...artists, { ...addedData }]); //spread operater to convert Model to standard JS object
	};

	return (
		<form>
			<h2 className="py-3">Add an artist</h2>
